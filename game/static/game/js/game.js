...
function fixBoardNumbering(){
    // Board numbering is already rendered correctly by Django.
    // Reordering squares here causes visual square numbers and
    // game logic positions to become out of sync.
    return;
}
